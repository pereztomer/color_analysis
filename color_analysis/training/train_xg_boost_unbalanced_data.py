...
from custom_kfold import create_k_fold
...
def main():
    ...
    json_files_path = '/home/tomer/GitProjects/DeepLearning/Data/color_analysis_json_files'
    experiment_paths = glob.glob(f'{json_files_path}/**/train_validation_unbalancedcolor_feature_vec.json', recursive=True)
    ...
    for exp_json_file_path in experiment_paths:
        try:
            ...
            task = Task.init(
                project_name=f'color_analysis_orgenized/xgboost/fvecs_percentage/unbalanced/approved_vals_{json_file_params["approved_vals"]}',
                task_name=exp_name)
